# Import các thư viện cần thiết từ Tkinter và tkcalendar
from tkinter import *
from tkinter import messagebox, ttk  # Thư viện hỗ trợ hiển thị thông báo và bảng
from tkcalendar import DateEntry  # Thư viện để chọn ngày

# Lớp Tooltip dùng để hiển thị gợi ý khi di chuột qua các widget
class Tooltip:
...
class LoginView:
    ...
    def login(self):
        ...
        if self.controller.verify_user(username, password):
            ...
            messagebox.showerror("Error", "Đăng nhập thất bại!")  # Thông báo lỗi
